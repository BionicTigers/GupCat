...
class MainOp : LinearOpMode() {
    override fun runOpMode() {
        ...
        gamepad2.getJoystick(GamepadEx.Joysticks.LEFT_JOYSTICK).deadzone = 0.3
//        gamepad2.getJoystick(GamepadEx.Joysticks.LEFT_JOYSTICK).onChange {
//            println("updating")
//            lift.trim += it.y.withSign(300 * Scheduler.deltaTime)
//        }

        Scheduler.add(ContinuousCommand { lift.trim += -gamepad2.getJoystick(GamepadEx.Joysticks.LEFT_JOYSTICK).state!!.y * (100.0 * Scheduler.deltaTime) })

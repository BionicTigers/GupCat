...
//            .setOnExit  { odometrySystem.pose = Pose(odometrySystem.pose.x, 1300.0, odometrySystem.pose.degrees); Scheduler.add(rotate) }
//        rotate
//            .setOnEnter { drivetrain.moveToPose(Pose(0.0,1300.0,100.0)) }
//            .setAction  { println(drivetrain.moveFinished); println(odometrySystem.pose); drivetrain.moveFinished }
//            .setOnExit  { odometrySystem.pose = Pose(odometrySystem.pose.x, odometrySystem.pose.y, 90.0); Scheduler.add(liftPivot) }
////        liftPivot
